...
public class ListaCompras {
	...
	private static void mostrarProducto() {
		for (String string : listaCompra) {
			System.out.println("Los productos de la lista son: " + listaCompra);
		}
		
	}
	//Método para eliminar el producto que introduzca el usuario por consola con el metodo .remove y con .contains para comprobar si esta en la lista
